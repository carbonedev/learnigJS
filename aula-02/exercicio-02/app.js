...
const myFavoriteTom = (` Meu favorito é ${tom} ${firstTom}`);
...
let randomWord = 'Arapongas'
let ultimaLetra = randomWord[randomWord.length-1];
...
const name = 'denis carbone';

function capitalizeFirst(str){
  const firstLetter = str.toLowerCase().replace(/(?:^|\s)\S/g, function(a){
...
// console.log(capitalizeFirst(name));
...
console.log(capitalizeFirst(`texto string Linha1`));